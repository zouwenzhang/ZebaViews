...
import com.zeba.views.click.ColorUtils;
...
public class RippleDetector {
    private static final String TAG = "RippleDetector";
    ...
    public RippleDetector(Context context, View view, Callback callback, int color) {
        mView = view;
        mCallback = callback;
        setColor(color);
