 ...
 * @Date 2020/3/13
 */
public class NestedScrollLayout extends ViewGroup implements ScrollingView, NestedScrollingParent2, NestedScrollingChild2 {
    ...
    public NestedScrollLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = null;
        try {
            a = context.obtainStyledAttributes(attrs, R.styleable.NestedScrollLayout);
            isPermanent = a.getBoolean(R.styleable.NestedScrollLayout_isPermanent, false);
        } finally {
            if (a != null) {
                a.recycle();
            }
...
//        // 导致ConsecutiveScrollerLayout追踪布局的滑动出现偏差
        ...
        if (size > 0) {
            ...
            if (isScrollTop) {
                for (int i = 0; i < size; i++) {
                    ...
                    if (view instanceof NestedScrollViewPager) {
                        NestedScrollViewPager viewPager = (NestedScrollViewPager) view;
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = null;
            try {
                a = c.obtainStyledAttributes(attrs, R.styleable.NestedScrollLayout_Layout);

                isConsecutive = a.getBoolean(R.styleable.NestedScrollLayout_Layout_layout_isConsecutive, true);
                isNestedScroll = a.getBoolean(R.styleable.NestedScrollLayout_Layout_layout_isNestedScroll, true);
                isSticky = a.getBoolean(R.styleable.NestedScrollLayout_Layout_layout_isSticky, false);
                isTriggerScroll = a.getBoolean(R.styleable.NestedScrollLayout_Layout_layout_isTriggerScroll, false);
                isSink = a.getBoolean(R.styleable.NestedScrollLayout_Layout_layout_isSink, false);
                int type = a.getInt(R.styleable.NestedScrollLayout_Layout_layout_align, 1);
